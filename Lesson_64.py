...
Mazda = Car('красный', 'Mazda', False)
test_drive(Mazda)

town = TownCar('оранжевый', 'Suzuki')
test_drive(town)

McLaren = SportCar('Creighton Brown', 'McLaren')
test_drive(McLaren)

workhorse = WorkCar('синий', 'ГАЗель Next')
test_drive(workhorse)

dps = PoliceCar('белый', 'UAZ Hunter')
test_drive(dps)